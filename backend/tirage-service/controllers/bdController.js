...
exports.listeTirage = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la récupération des tirages" });
  }
};
...
exports.applyAdvancedFilters = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de l'application des filtres avancés" });
  }
};
...
exports.supprimerTirage = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de la suppression du tirage" });
  }
};
...
exports.getPseudos = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Erreur serveur lors de la récupération des pseudos" });
  }
};
...
exports.saveTirage = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Erreur lors de l'enregistrement des tirages" });
  }
};
